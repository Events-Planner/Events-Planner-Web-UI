...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-hidden">
      ...
      {/* Hero Section */}
      <Container maxWidth="lg" className="pt-20 pb-16 relative z-10 text-center">
        ...
        <Typography 
          variant="h6" 
          className="text-slate-400 text-lg sm:text-xl font-normal max-w-2xl mx-auto mb-10 leading-relaxed"
        >
        ...
        <Box className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button
            ...
            className="w-full sm:w-auto px-8 py-4 text-lg font-bold rounded-xl shadow-lg shadow-indigo-500/25"
          ...
          <Button
            ...
            size="large"
            startIcon={<LockOpen />}
            className="w-full sm:w-auto px-8 py-4 text-lg font-semibold rounded-xl border-slate-700 text-slate-200 hover:border-indigo-400 hover:bg-slate-800/50"
        ...
        <Box className="mt-16 pt-12 border-t border-slate-800/80 grid grid-cols-1 sm:grid-cols-3 gap-8">
          {stats.map((stat, idx) => (
      ...
      <Container maxWidth="lg" className="py-20 relative z-10">
        <Box className="text-center mb-14">
          <Typography variant="h3" className="text-3xl sm:text-4xl font-bold text-white mb-4" sx={{ fontWeight: 700 }}>
            Everything You Need To Host Great Events
          </Typography>
          <Typography variant="body1" className="text-slate-400 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {highlights.map((item, index) => (
            <div 
              key={index} 
              className="p-8 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-all flex gap-5 items-start"
            >
      ...
      <Container maxWidth="lg" className="pb-20">
        <div className="relative rounded-3xl bg-gradient-to-r from-indigo-900/40 via-purple-900/20 to-slate-900 border border-indigo-500/30 p-10 sm:p-16 text-center overflow-hidden">
          <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
            <Typography variant="h3" className="text-3xl sm:text-5xl font-extrabold text-white mb-4" sx={{ fontWeight: 800 }}>
              Start Planning Your Next Event Today
            </Typography>
            <Typography variant="body1" className="text-slate-300 text-lg mb-8">
